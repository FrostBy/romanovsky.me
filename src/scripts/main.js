...
const i18n = rosetta({
  ...
  ru: {
    ...
    heroTitle: 'Технический руководитель и серийный предприниматель',
    heroTagline: 'Создаю продукты, команды и компании',
    resumeTitle: 'Резюме',
    resumePdf: 'PDF',
    resumeWord: 'Word',
    footer: `© ${new Date().getFullYear()} Владислав Романовский`,
    pageTitle: 'Владислав Романовский — Технический руководитель и серийный предприниматель',
    metaDescription: 'Технический руководитель и серийный предприниматель с 15+ годами в разработке ПО и 8+ годами управления командами. Engineering Manager, Tech Lead, CTO и основатель стартапов. Эксперт в Node.js, React, TypeScript и облачной архитектуре. Создавал продукты для Fintech, Gaming, SaaS и AI.',
    ogTitle: 'Владислав Романовский — Технический руководитель и серийный предприниматель',
    ...
    twitterTitle: 'Владислав Романовский — Технический руководитель и серийный предприниматель',
